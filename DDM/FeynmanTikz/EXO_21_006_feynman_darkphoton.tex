...
\begin{tikzpicture}
	...
	\vertex[right=of b   ] (c);
    \vertex[above right=of c,  yshift =  2mm, xshift = -3mm, dot, style = gray] (c1){};
	\vertex[below right=of c,  yshift = -2mm, xshift = -3mm, dot, style = gray] (c2){};
	\vertex[above= 3 mm of c1] {\(\epsilon\)}; %simple trick to draw vertex labels
	\vertex[above= 3 mm of c2] {\(\epsilon\)}; %simple trick to draw vertex labels
