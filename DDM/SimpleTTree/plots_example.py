...
f2, t2, l2 = getTree(inputFolder+"test.root", "SimpleNTupler", "DDTree", "HLT_DoubleL2Mu23NoVtx_2Cha_v2")
f3, t3, l3 = getTree(inputFolder+"test.root", "SimpleNTupler", "DDTree", "HLT_DoubleL2Mu10NoVtx_2Cha_VetoL3Mu0DxyMax1cm_v1")
f4, t4, l4 = getTree(inputFolder+"test.root", "SimpleNTupler", "DDTree", "HLT_DoubleL3Mu16_10NoVtx_DxyMin0p01cm_v1")
...
variables  = []
variables.append({"var_name":"dim_pt", "selection": selection, "nbins": 50, "inibin": 0, "endbin": 100, "norm":False})
...
variables.append({"var_name":"evt_run", "selection": selection, "nbins": 356386-352499, "inibin": 352499, "endbin": 356386, "norm":False})
variables.append({"var_name":"evt_lumi", "selection": selection, "nbins": 250, "inibin": 0, "endbin": 250, "norm":False})
#variables.append({"var_name":"patmu_nTrackerLayers", "selection": selection, "nbins": 20, "inibin": 0, "endbin": 20, "norm":True})
variables.append({"var_name":"trig_hlt_path", "selection": selection, "nbins": 20, "inibin": 0, "endbin": 20, "norm":False})
