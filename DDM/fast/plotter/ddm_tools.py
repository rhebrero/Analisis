...
def plot_ratio(root_file1, histogram1, legend1, root_file2, histogram2, legend2, xtitle, ytitle, ratiotitle, selection, output_file, tlist = "main"):
    """
    ...
    if len(tlist)>0 and len(TLatexList):
